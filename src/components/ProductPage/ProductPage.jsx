...
const ProductPage = () => {
    ...
    const questions = [
        ...
        },
        {
            ...
            answer: `Политика возврата KBN<br><br>

                Мы стремимся к тому, чтобы вы были довольны покупкой, но если изделие не подошло, вы можете вернуть его в течение 14 дней с момента получения.<br><br>

                Условия возврата:<br><br>

                1. Состояние товара: принимаем только новые, не ношенные вещи с сохранёнными ярлыками и упаковкой.<br>
                2. Возврат средств: деньги возвращаются тем же способом, которым был оплачен заказ, в течение 10 рабочих дней после получения возвращённого товара.<br>
                3. Процедура возврата: свяжитесь с нашей поддержкой, и мы вышлем инструкции по возврату товара. @kbn_mg<br><br>

                Обратите внимание: расходы на обратную доставку оплачивает покупатель, если товар не имеет брака.`
                },
                {
                    question: "Как ухаживать",
                    answer: `1. Стирка: 30°C, деликатный режим, без отбеливателя и кондиционеров для белья.<br>
                    2. Сушка: без машинной сушки, расправьте на горизонтальной поверхности.<br>
                    3. Глажка: редко требуется, но если нужно — с изнанки на низкой температуре.<br>
                    4. Хранение: в сложенном виде или на плечиках, вдали от прямого света.<br><br>
